...
// DisplayTodos component for rendering and managing the list of todos
const DisplayTodos = ({
  data, // Array of todo items
  setData, // Function to update the data state
  setEdit, // Function to set the edit state
  setDeleteNotificationTitle, // Function to set the delete notification title
  setDeleteNotification, // Function to set the delete notification visibility
  setTaskDetails, // Function to set task details for viewing or editing
}) => {
  ...
  // useEffect hook to filter data based on search input
  useEffect(() => {
    ...
    setSearchResults(filterResults); // Update search results based on the filter
  }, [data, search]);

  // Function to provide task status based on completion percentage
